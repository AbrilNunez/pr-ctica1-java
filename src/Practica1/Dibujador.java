...
public class Dibujador extends Panel 
{
	...
	/* Devuelve el alto del dibujador en pixeles.
	 */
	public int alto()
	{
	...
	/* Devuelve el ancho del dibujador en pixeles.
	 */
	public int ancho()
	{
	...
	/*
	  Dibuja una linea en el dibujador entre las coordenadas dadas.
	  @param desde Punto de inicio de la linea
	  @param hasta Punto de final de la linea
	 */
